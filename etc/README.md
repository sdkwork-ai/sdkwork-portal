# sdkwork-portal Source Configuration
...
| `runtimeCode` | `portal` |
| Config root | `/etc/sdkwork/portal/` |
| Runtime TOML | `/etc/sdkwork/portal/config.toml` |
| Secrets | `/etc/sdkwork/portal/secrets/` |
| Override | `SDKWORK_PORTAL_CONFIG_FILE` |
