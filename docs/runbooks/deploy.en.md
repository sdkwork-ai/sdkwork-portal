# Runbook — sdkwork-portal deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-portal-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-portal/bundle`, loads the image, starts
