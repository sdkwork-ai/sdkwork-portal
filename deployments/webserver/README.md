...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `portal-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `portal-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `portal-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `portal.sdkwork.com` | 443 ssl + 80 |
