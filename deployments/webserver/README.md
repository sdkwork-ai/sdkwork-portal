...
Module `sdkwork-portal` · runtime code `portal` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `portal-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `portal-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `portal-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `portal-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `portal.sdkwork.com` | 443 ssl + 80 |
